  ...
  methods: {
    ...
    _touchMoveEvent: function (e) {
      ...
      if (e.touches.length == 1) {
        ...
        //console.log(this.data.marginLeft)
      }
      //双指缩放事件
    ...
    _reboundAnimation: function () {
      var width = this.data.page_width;
      var viewwidth = this.data.imgHeight;
      ...
      if (this.data.marginLeft < 0 && (this.data.imgWidth - Math.abs(this.data.marginLeft)) < this.data.page_width) {
        this.setData({
          marginLeft: this.data.marginLeft + 4
        })
      }
